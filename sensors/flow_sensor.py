...
class FlowSensor(SensorBase):
    ...
    def read_data(self):
        ...
        try:
            ...
            temp_supply_regs = self.device.read_registers(0x0033, 2)
            temp_supply = self.read_float(temp_supply_regs, byte_order)
            
            temp_return_regs = self.device.read_registers(0x0035, 2)
